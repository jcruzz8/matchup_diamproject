                ...
                {game.distribution_model === 'Auto-Balanceamento' && (
                    <>
                        ...
                        <div className="d-flex justify-content-between align-items-center mt-2">
                            ...
                            <Button className="btn-custom-red px-4 py-2 fw-bold fs-5 shadow-sm rounded-3" 
                                onClick={handleInscrever}
                                disabled={game.occupied_data?.players?.includes(parseInt(localStorage.getItem('matchup_user_id')))}
                            >
                ...
                {game.distribution_model === 'Equipa vs Equipa' && (
                    <Row className="gx-3">
                        <Col xs={6} className="border-end border-dark text-center">
                            ...
                            <Button 
                                outline={!game.occupied_data?.positions?.includes('equipa1') && !game.occupied_data?.players?.includes(parseInt(localStorage.getItem('matchup_user_id')))} 
                                color={game.occupied_data?.positions?.includes('equipa1') ? "secondary" : "dark"} 
                                className="w-100 fw-bold border-2 rounded-3 py-2" 
                                onClick={() => openTeamModal('equipa1')}
                                disabled={game.occupied_data?.positions?.includes('equipa1') || game.occupied_data?.players?.includes(parseInt(localStorage.getItem('matchup_user_id')))}
                            >
                        ...
                        <Col xs={6} className="text-center">
                            ...
                            <Button 
                                outline={!game.occupied_data?.positions?.includes('equipa2') && !game.occupied_data?.players?.includes(parseInt(localStorage.getItem('matchup_user_id')))} 
                                color={game.occupied_data?.positions?.includes('equipa2') ? "secondary" : "dark"} 
                                className="w-100 fw-bold border-2 rounded-3 py-2" 
                                onClick={() => openTeamModal('equipa2')}
                                disabled={game.occupied_data?.positions?.includes('equipa2') || game.occupied_data?.players?.includes(parseInt(localStorage.getItem('matchup_user_id')))}
                            >
                    ...
                    <>
                        ...
                        <div className="d-flex justify-content-between align-items-center mt-3 pt-3 border-top">
                            ...
                            <Button className="btn-custom-red px-4 py-2 fw-bold fs-5 shadow-sm rounded-3"
                                ...
                                onClick={handleInscrever}
                            >
                                {posicaoSelecionada ? 'Confirmar Lugar' : 'Escolhe Lugar'}
                            </Button>
                        </div>
                    </>
                )}
